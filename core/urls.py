...
from core.views.subsystem_status import create_subsystem_status, get_subsystem_status_list, get_subsystem_status_detail, \
...
urlpatterns = [
    ...
    path('subsystem_statuses/', create_subsystem_status, name='subsystem-status-create'),
